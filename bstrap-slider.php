<div id="bstrap-slider" class="carousel slide" data-ride="carousel">
  <!-- Indicators -->
  ...
  <!-- Controls -->
  <a class="left carousel-control" href="#bstrap-slider" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left"></span>
  </a>
  <a class="right carousel-control" href="#bstrap-slider" data-slide="next">
